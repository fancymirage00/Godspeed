...
function Footer() {
    return (
        ...
        <footer className="bg-white rounded-lg ml-10">
            <div className="max-w-screen-xl mx-8 pb-6">
                <hr className="m-7"></hr>
                <div className="">
                    <div className="flex justify-between">

                        <h3 className="font-bold">Godspeed Airways</h3>
                        

                        <Badge color="blue" radius="large">
                            <a
                                href="#"
                                className="transition hover:text-gray-600/75"
                            >
                        ...
                        <Badge color="red" radius="full">
                            <a className="transition hover:text-gray-700/75 font-medium" href="#"> Contributors </a>
                        </Badge>

                        <Badge color="amber" radius="full">
                            <a className="transition hover:text-gray-700/75 font-medium" href="#">Help</a>
                        </Badge>

                        <Badge color="green" radius="full">
                            <a className="transition hover:text-gray-700/75 font-medium" href="#"> Cleared for takeoff </a>
                        </Badge>
                    </div>
                </div>

                <div className="mt-1">
                    <div className="text-center sm:flex sm:justify-between sm:text-left flex flex-col">
                        <p className="text-sm text-gray-500">
                            <span className="block text-gray-700 sm:inline font-medium">&copy; 2024 DSA Group 7 </span>
                        </p>
                        <p className="text-sm text-gray-500">
                            <span className="block text-gray-700 sm:inline font-medium">All rights reserved. </span>
                        </p>
                    </div>
                </div>
            </div>
